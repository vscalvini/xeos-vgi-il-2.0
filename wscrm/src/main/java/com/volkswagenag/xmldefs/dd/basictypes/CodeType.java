...
/**
 * A character string (letters, figures, or symbols) that represents an element from a list of codes that is maintained by an external (e.g. ISO) or internal party (e.g. Integration Architecture).
 * 
